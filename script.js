...
const I18N = {
  es: {
    ...
    "hero.lead": "Cuentas, presupuestos, listas, familia y eventos compartidos — todo en una sola app. Con Mochi, tu asesor de vida que te arma planes paso a paso, y tu Life Score diario. Simple y privada.",
    ...
    "feat.advisor.t": "Mochi, tu asesor de vida",
    "feat.advisor.d": "Cuéntale una meta —comprar casa, cambiar de empleo, emprender— y te arma un plan honesto paso a paso que baja a tus Listas.",
  ...
  en: {
    ...
    "hero.lead": "Bills, budgets, lists, family, and shared events — all in one app. With Mochi, your life advisor that builds step-by-step plans, and your daily Life Score. Simple and private.",
    ...
    "feat.advisor.t": "Mochi, your life advisor",
    "feat.advisor.d": "Tell it a goal —buy a house, change jobs, start a business— and it builds an honest step-by-step plan that lands in your Lists.",
